...
Failures record whether planning, approval, or evidence preparation failed. Ordinary failures continue by default. Fail-fast and STOP skip all remaining items. Partially planned or approved jobs remain recorded for audit and deliberate recovery rather than being silently deleted or rolled back.
